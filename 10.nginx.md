追記: kazeburo.conf が参考になる！ https://github.com/kazeburo/isucon3qualifier-myhack/blob/master/conf/nginx.conf
...
$ sudo yum install nginx # これだと最新版じゃないんだけどビルド時間とかもったいないしなぁ...
