...
show status like '%threads_%';
  created が大きかったら thread_cache_size 大きくするとか
  show global variables like '%thread_cache_size%';
  set global thread_cache_size = 600;

  mysqladmin -u root extended-status | grep -E 'Max|Threads'
| Max_used_connections                     | 985         |
| Threads_cached                           | 224         |
| Threads_connected                        | 760         |
| Threads_created                          | 13666       |
| Threads_running                          | 31          |

Threads_cached の値をみながら。600 で足りてるな
