...
```
とエラーが出ました。50 worker で 10GB に抑えようと思ったら これぐらいですね。
...
use Unicorn::WorkerKiller::MaxRequests, 3072, 4096
# Max Memory size (RSS) per worker
# use Unicorn::WorkerKiller::Oom, (175*(1024**2)), (200*(1024**2)) #=> ダメだった. エラーが出る
use Unicorn::WorkerKiller::Oom, (25*(1024**2)), (50*(1024**2))
```

尚、WorkerKiller が発動するとログに
...
と出るようです。ただ、`(25*(1024**2)), (50*(1024**2))` だと worker が 1sec しか持たず速攻殺されますね ...
